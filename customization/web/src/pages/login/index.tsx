...
const Login = () => {
  ...
  const toAzure = () => {
    window.location.href =
      'https://login.microsoftonline.com/#{AZURE_TENANT_ID}#/oauth2/v2.0/authorize?client_id=#{CLIENT_ID}#&response_type=code&redirect_uri=https%3a%2f%2f#{HOST}#%2fv1%2fuser%2fazure_callback&response_mode=query&scope=openid%20profile%20email&prompt=select_account';
  };
